## 🤖📰 Rasa & Azure OpenAI Chatbot — New York Times News Bot
...
## 🏗️ Architecture
Message flow: **User → WhatsApp → Twilio Sandbox → Ngrok webhook → Rasa chatbot → New York Times API | Azure OpenAI → Response**
